...
// Social media links
const socialLinks = {
  facebook: "mybio.ranzzkandjut.my.id",
  whatsapp: "mybio.ranzzkandjut.my.id",
  instagram: "mybio.ranzzkandjut.my.id",
  telegram: "mybio.ranzzkandjut.my.id",
};
